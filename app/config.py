...
WORKFLOW_PLANNER_ROLE_NAME_ENV = "APP_WORKFLOW_PLANNER_ROLE_NAME"
WORKFLOW_PLANNER_ROLE_INSTRUCTION_ENV = "APP_WORKFLOW_PLANNER_ROLE_INSTRUCTION"
WORKFLOW_EXECUTOR_ROLE_NAME_ENV = "APP_WORKFLOW_EXECUTOR_ROLE_NAME"
WORKFLOW_EXECUTOR_ROLE_INSTRUCTION_ENV = "APP_WORKFLOW_EXECUTOR_ROLE_INSTRUCTION"
...
def get_workflow_planner_role_name() -> str:
    return os.getenv(WORKFLOW_PLANNER_ROLE_NAME_ENV, DEFAULT_PLANNER_ROLE_NAME).strip() or DEFAULT_PLANNER_ROLE_NAME


def get_workflow_planner_role_instruction() -> str:
    return (
        os.getenv(WORKFLOW_PLANNER_ROLE_INSTRUCTION_ENV, DEFAULT_PLANNER_ROLE_INSTRUCTION).strip()
        or DEFAULT_PLANNER_ROLE_INSTRUCTION
    )


def get_workflow_executor_role_name() -> str:
    return os.getenv(WORKFLOW_EXECUTOR_ROLE_NAME_ENV, DEFAULT_EXECUTOR_ROLE_NAME).strip() or DEFAULT_EXECUTOR_ROLE_NAME


def get_workflow_executor_role_instruction() -> str:
    return (
        os.getenv(WORKFLOW_EXECUTOR_ROLE_INSTRUCTION_ENV, DEFAULT_EXECUTOR_ROLE_INSTRUCTION).strip()
        or DEFAULT_EXECUTOR_ROLE_INSTRUCTION
    )
...
def get_workflow_reviewer_role_name() -> str:
    return os.getenv(WORKFLOW_REVIEWER_ROLE_NAME_ENV, DEFAULT_REVIEWER_ROLE_NAME).strip() or DEFAULT_REVIEWER_ROLE_NAME


def get_workflow_reviewer_role_instruction() -> str:
    return (
        os.getenv(WORKFLOW_REVIEWER_ROLE_INSTRUCTION_ENV, DEFAULT_REVIEWER_ROLE_INSTRUCTION).strip()
        or DEFAULT_REVIEWER_ROLE_INSTRUCTION
    )
