export const UI_TEXT = {
  ...
  state: {
    loadingTraceList: "正在加载...",
    loadingTraceDetail: "正在加载...",
    traceListNoPermission: "当前账号无权访问该页面",
    traceDetailNoPermission: "当前账号无权访问该页面",
    traceListLoadFailed: "加载失败，请重试",
    traceDetailLoadFailed: "加载失败，请重试",
    traceRecordMissing: "关联 Trace 不可用或已缺失",
    staleTraceReferenceHint: "部分关联请求链路可能已不可用，打开后如提示记录不存在，请返回当前页面继续查看其他记录。",
    missingTraceId: "缺少请求链路编号。",
    missingTaskId: "缺少任务编号。",
    loadingTaskSummary: "正在加载...",
    taskNoPermission: "当前账号无权访问该页面",
    taskSummaryLoadFailed: "加载失败，请重试",
    taskNotFound: "未找到任务",
    noTaskSummary: "当前任务暂无可用摘要。",
    loadingOperationsOverview: "正在加载...",
    operationsNoPermission: "当前账号无权访问该页面",
    operationsOverviewLoadFailed: "加载失败，请重试",
    noRecentData: "暂无近期数据",
